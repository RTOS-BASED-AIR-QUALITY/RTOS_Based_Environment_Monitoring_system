...
void vBlinkLedTask(void* pvParam)
{
	TickType_t PreviousWakeTime = xTaskGetTickCount();
	while(1)
	{
		HAL_GPIO_TogglePin(GPIOD, GPIO_PIN_14);
		vTaskDelayUntil(&PreviousWakeTime, 5000/portTICK_RATE_MS);
	}
	vTaskDelete(NULL);
}
...
int main(void)
{
  ...
  HAL_UART_Transmit(&huart2, (uint8_t*)"This is environment monitoring module\r\n", 39, HAL_MAX_DELAY);

//  DHT22_Data_t readingDHT;
//  MQ135_Data readMQ135;
